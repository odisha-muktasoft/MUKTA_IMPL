...
public class RegisterQueryBuilder {
    ...
    public String getAttendanceRegisterSearchQuery(AttendanceRegisterSearchCriteria searchCriteria, List<Object> preparedStmtList) throws InvalidTenantIdException {
        ...
        String finalQuery =  addPaginationWrapper(query.toString(), preparedStmtList, searchCriteria);
        return  multiStateInstanceUtil.replaceSchemaPlaceholder(finalQuery, tenantId);
    }
