...
public class PaymentRepository {
	...
	public List<Payment> search(@Valid PaymentSearchRequest paymentSearchRequest) {
		...
		return jdbcTemplate.query(queryStr, paymentBillRowMapper, preparedStatementValues.toArray());
	}
	...
	public Integer count(@Valid PaymentSearchRequest paymentSearchRequest) {
		...
		return jdbcTemplate.queryForObject(queryStr, Integer.class, preparedStatementValues.toArray());
	}
}
