...
public class LineItemsRepository {
    ...
    @Autowired
    public LineItemsRepository(LineItemsRowMapper rowMapper, LineItemsQueryBuilder queryBuilder, JdbcTemplate jdbcTemplate, MultiStateInstanceUtil multiStateInstanceUtil) {
