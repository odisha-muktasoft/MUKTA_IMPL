...
public class BoundaryMigrate {
    ...
    String boundaryRelationshipUrl = "http://boundary-service.egov:8080/boundary-service/boundary-relationships/_create";

    String boundaryUrl = "http://boundary-service.egov:8080/boundary-service/boundary/_create";

    String boundaryHierarchyUrl = "http://boundary-service.egov:8080/boundary-service/boundary-hierarchy-definition/_create";
