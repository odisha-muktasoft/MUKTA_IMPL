...
mixin _$MeasurementCrudBlocEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(
            String tenantId, Measurement measurement, WorkFlow workFlow)
        update,
...
abstract class _$$MeasurementUpdateBlocEventCopyWith<$Res> {
  ...
  @useResult
  $Res call({String tenantId, Measurement measurement, WorkFlow workFlow});
...
class _$MeasurementUpdateBlocEvent implements MeasurementUpdateBlocEvent {
  ...
  @override
  String toString() {
    return 'MeasurementCrudBlocEvent.update(tenantId: $tenantId, measurement: $measurement, workFlow: $workFlow)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, tenantId, measurement, workFlow);
  ...
  TResult when<TResult extends Object?>({
    ...
    return update(tenantId, measurement, workFlow);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return update?.call(tenantId, measurement, workFlow);
  }
...
abstract class MeasurementUpdateBlocEvent implements MeasurementCrudBlocEvent {
  const factory MeasurementUpdateBlocEvent(
      ...
      required final WorkFlow workFlow}) = _$MeasurementUpdateBlocEvent;
