                                                                      ...
                                                                      context
                                                                          ...
                                                                          .add(
                                                                            WorkOrderDeclineEvent(
                                                                                contractsModel: workOrderList.first['payload'],
                                                                                action: 'DECLINE',
                                                                                comments: 'Work Order has been declined by CBO'),
                                                                          );
                                                                      Navigator.of(
                                                                              context,
                                                                              rootNavigator: true)
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        context.router.push(AttendanceRegisterTableRoute(
                                                                            registerId:
                                                                                (contracts?.contracts ?? []).first.additionalDetails?.attendanceRegisterNumber.toString() ?? ''.toString(),
                                                                  ...
                                                                  DigitOutlineIconButton(
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      Navigator.of(
                                                                              ...
                                                                              rootNavigator: true)
                                                                          .pop();
                                                                      context.read<ValidTimeExtCreationsSearchBloc>().add(SearchValidTimeExtCreationsEvent(
                                                                          contract: contracts
                                                                              ?.contracts
                                                                              ?.first,
                                                                          contractNo: (contracts?.contracts ?? [])
                                                                              .first
                                                                              .contractNumber
                                                                              .toString(),
                                                                          tenantId: (contracts?.contracts ?? [])
                                                                              .first
                                                                              .tenantId
                                                                              .toString(),
                                                                          status:
                                ...
                                loaded: (ContractsModel? contracts) {
                                  if (contracts?.contracts != null) {
                                    ...
                                    workFlowDetails = contracts.contracts!
                                        ...
                                        .toList();
                                    // fileStoreList = ;
                                    attachedFiles = contracts.contracts!.first
                                                    .documents !=
                                                null &&
                                            contracts
                                                    .contracts!
