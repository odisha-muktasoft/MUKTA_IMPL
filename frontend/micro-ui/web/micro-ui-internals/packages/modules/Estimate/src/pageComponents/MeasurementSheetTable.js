...
const MeasurementSheetTable = ({control, watch, config, props}) => {
  // const { control, watch, config, props } = data;
  ...
  return (
    <table className="table reports-table sub-work-table" style={{ marginTop: "1rem" }}>
      <thead>
        <tr>{renderHeader()}</tr>
      </thead>
      <tbody>
